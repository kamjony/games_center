...
class GamesListModel {
  ...
  static const empty = GamesListModel(
    count: 0,
    next: '',
    previous: '0',
    results: [],
...
class Filters {
  ...
  factory Filters.fromJson(Map<String, dynamic> json) => Filters(
        years: json["years"] == null
            ? null
            : List<FiltersYear>.from(json["years"].map((x) => FiltersYear.fromJson(x))),
      );
...
class Result {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "platforms":
            platforms == null ? null : List<dynamic>.from(platforms!.map((x) => x.toJson())),
